...
Thick lines represent running in streets or with uncontrolled or light-controlled grade crossings; thin lines represent thru-running onto sections with grade-separations or crossing gates.  Other frequent rail lines are shown in light gray, ferries in cyan.  All lines shown run at least every 20 minutes during the day on weekdays as of the end of 2019.<br>
