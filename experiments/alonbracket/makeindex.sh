...
for file in $@; do if [ -f $file ]; then
  ...
  if [ $city = szx ]; then NAME="Shenzhen"; elif [ $city = hkg ]; then NAME="Hong Kong"; elif [ $city = xxx ]; then NAME="???"; else NAME=`cat ~/timelines/timelines/$city/name`; fi
...
<p>
Based on frequent midday service (<a href="../../timelines/notes.html">notes</a>). Current as of September 2020.<br>
